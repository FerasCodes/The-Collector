...
class CommandGenerator:
    def __init__(self, root):
        ...
        tk.Label(basic_frame, text="Basic Commands", font=("Times New Roman", 12, "bold")).pack()
        ...
        tk.Label(advanced_frame, text="Advanced Commands", font=("Times New Roman", 12, "bold")).grid(row=0, column=0, columnspan=4, sticky='n', pady=10)
    ...
    def generate_batch(self):
        ...
        if folder_path:
            ...
            messagebox.showinfo("Success", f"Batch script generated in {folder_dir}")
